...
export default function CreatorSettingsPage() {
  ...
  return (
    <div className="max-w-xl">
      ...
      <OcCard className="mt-4 p-5">
        <p className="text-sm font-medium text-oc-ink">Know a brand looking for creators?</p>
        <p className="mt-1 text-xs text-oc-ink-muted">Invite them to post a campaign on OpenCollab.</p>
        <div className="mt-3">
          <ShareButton path="/register/brand" shareTitle="Post a campaign on OpenCollab" label="Invite a Brand" copiedLabel="Copied" />
        </div>
      </OcCard>
    </div>
  );
