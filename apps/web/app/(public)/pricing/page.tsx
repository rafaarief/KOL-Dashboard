...
export default function PricingPage() {
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <p className="mt-2 text-sm text-oc-ink-muted">OpenCollab.id is free for both brands and KOLs during this MVP phase.</p>
      ...
      <div className="mt-8">
        ...
        <p className="mt-2 text-sm text-oc-ink-muted">
          ...
          campaign, a collaboration success fee, featured campaign or KOL placements, and paid verification review.
