  ...
  return (
    <div className="mx-auto max-w-3xl">
      ...
      <section className="mt-8 rounded-oc-lg border border-oc-border bg-tile-blush p-6 shadow-oc-sm">
        <h2 className="font-display text-lg font-bold text-oc-ink">🎨 For KOLs</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-oc-ink-muted">
          <li>Create a free KOL profile with your social accounts, rate card, and availability.</li>
      ...
      <section className="mt-6 rounded-oc-lg border border-oc-border bg-tile-sky p-6 shadow-oc-sm">
        ...
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-oc-ink-muted">
          ...
          <li>Publish a campaign describing your scope of work, budget, and KOL requirements.</li>
          <li>Review applicants as they come in, shortlist your favorites, and accept the best fits.</li>
          <li>Or browse the KOL directory directly and invite KOLs who match your brief.</li>
          <li>Coordinate delivery and payment directly with your chosen KOLs.</li>
        </ol>
      </section>
      ...
      <section className="mt-8">
        ...
        <p className="mt-3 text-sm text-oc-ink-muted">
          ...
          calculate commissions automatically. Brands and KOLs agree on terms and settle payment directly, through
