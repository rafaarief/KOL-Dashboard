...
export default function HowItWorksPage() {
  return (
    <div className="mx-auto max-w-3xl">
      <h1 className="text-2xl font-bold text-oc-ink">How OpenCollab Works</h1>

      <section className="mt-8">
        <h2 className="text-lg font-semibold text-oc-ink">For Creators</h2>
      ...
      <section className="mt-8">
        <h2 className="text-lg font-semibold text-oc-ink">For Brands</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-sm text-oc-ink-muted">
      ...
      <section className="mt-8">
        <h2 className="text-lg font-semibold text-oc-ink">What OpenCollab.id doesn&apos;t do (yet)</h2>
